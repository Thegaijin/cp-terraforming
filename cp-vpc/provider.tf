...
# resource "aws_subnet" "cp_tf_pub_subnet1" {
...
# resource "aws_subnet" "cp_tf_pub_subnet2" {
#   vpc_id            = "${aws_vpc.cp_tf_vpc_02060600.id}"
...
# resource "aws_subnet" "cp_tf_priv_subnet1" {
#   vpc_id            = "${aws_vpc.cp_tf_vpc_02060600.id}"
...
# resource "aws_subnet" "cp_tf_priv_subnet2" {
#   vpc_id            = "${aws_vpc.cp_tf_vpc_02060600.id}"
